...
# 1. feladat
# Készítsen függvényt van_e néven!
# A függvénynek két paramétere van:
#   - a keresett betű (chr)
#   - a mondat (str)
# A függvény igaz értékkel tér vissza, ha a mondatban van a betű, hamissal ha nincs
# A függvény működjön kis és nagybetű esetén is
